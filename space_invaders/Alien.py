...
# https://www.clipartmax.com/download/m2i8A0b1K9K9G6G6_alien-ship-capitaine-america-pixel-art/
...
class Alien(pygame.sprite.Sprite):
    def __init__(self, x, y, atype):
        ...
        self.rect.topleft = (
            (self.x * self.sprite_size) + Settings.xoffset, 
    ...
    def draw(self, screen):
        if random.randint(0, 3000) <1:
            Settings.abullets.append(Laser(
            (self.x * self.sprite_size) + Settings.xoffset, 
            (self.y * self.sprite_size) + Settings.yoffset,
            5
            ))
